...
[![Open In
Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/yurialobao/deep-transfer-learning/blob/main/transfer_learning_template.ipynb)
...
This repository provides a **structured, reproducible, and
production-style Transfer Learning pipeline** built with TensorFlow and
Keras.
...
implements a complete workflow for binary image classification using a
pre-trained convolutional neural network (**MobileNetV2 trained on
ImageNet**).

The project is intentionally designed as a **reusable template** that
can be adapted to any binary image classification dataset with minimal
changes.
...
Transfer Learning enables high-performance computer vision systems even
...
By leveraging ImageNet pre-trained models, development time and
computational cost are drastically reduced while maintaining strong
...
This ensures reproducibility and removes manual bias from model
selection.
...
Fine-tuning did not improve validation performance in this case,
demonstrating that pre-trained ImageNet features were already
sufficient.
...
![Transfer Learning Accuracy](images/tl_accuracy.png) ![Transfer
Learning Loss](images/tl_loss.png)

### Fine-Tuning Phase

![Fine-Tuning Accuracy](images/ft_accuracy.png) ![Fine-Tuning
Loss](images/ft_loss.png)
